...
class VFNetRawHead(ATSSHead, FCOSHead):
    ...
    This VFNet Raw head = FCOS + ATSS - centerness branch
    ...
    Args:
        ...
        act_inplace (bool): Whether to use inplace mode for activation.
            Default: True.
    ...
    def _init_layers(self):
        ...
        self.vfnet_cls_conv = ConvModule(
            self.feat_channels,
            self.feat_channels,
            3,
            stride=1,
    ...
    def init_weights(self):
        ...
        normal_init(self.vfnet_cls_conv.conv, std=0.01)
    ...
    def forward(self, feats):
        ...
        return multi_apply(self.forward_single, feats, self.scales,
                           self.strides, self.reg_denoms)

    def forward_single(self, x, scale, stride, reg_denom):
        ...
        # predict the cls score
        cls_feat = self.vfnet_cls_conv(cls_feat)
