...
class ATSSVGFLHead(AnchorHead):
    ...
    This ATSS VFL GFL head allows to train ATSS with VFL or GFL.
    ...
    def __init__(self,
        ...
        super(ATSSVGFLHead, self).__init__(num_classes, in_channels, **kwargs)

        if self.use_vfl or self.use_gfl:
            self.loss_cls = build_loss(loss_cls_vgfl)
    ...
    def loss_single(self, anchors, cls_score, bbox_pred, centerness, labels,
        ...
        iou_scores = label_weights.new_zeros(labels.shape)
        ...
        if len(pos_inds) > 0:
            ...
            if self.use_gfl:
                iou_scores[pos_inds] = bbox_overlaps(
                    pos_decode_bbox_pred.detach(),
                    pos_decode_bbox_targets,
                    is_aligned=True)
