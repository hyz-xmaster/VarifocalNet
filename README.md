...
- Please check [INSTALL.md](docs/install.md) for installation. Note that you should change the version of PyTorch and CUDA to yours when installing **mmcv** (version of 1.0.5 is recommended) in `step c`, and clone this repo in `step d`, instead of mmdetection.
...
- `use_vfl` flag in those config files controls whether use the Varifocal Loss in training or not.
